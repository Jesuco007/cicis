...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="input-field col s12 m4">
                            <select name="tipo" id="tipo" required>
                                <option <?php echo e($usuario->tipo === 'DIR'?'selected':''); ?> value="DIR">Director</option>
                                <option <?php echo e($usuario->tipo === 'COO'?'selected':''); ?> value="COO">Coordinador</option>
                                <option <?php echo e($usuario->tipo === 'SEC'?'selected':''); ?> value="SEC">Secretaria</option>
                                <option <?php echo e($usuario->tipo === 'EST'?'selected':''); ?> value="EST">Estudiante</option>
                            </select>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\alfreding0\Documents\web-projects\yisu\cicis\resources\views/usuarios/edit.blade.php ENDPATH**/ ?>