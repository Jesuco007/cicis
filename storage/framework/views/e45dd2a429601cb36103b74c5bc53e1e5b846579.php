...
<div class="row">
    <form method="POST" action="<?php echo e(route('servicios.update', [$item->id])); ?>">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="input-field col s12 m4">
                            <input id="costo" type="text" class="validate" name="costo" value="<?php echo e($item->servicios->costo); ?>" required>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/grupo02cc/cicis/resources/views/servicios/edit.blade.php ENDPATH**/ ?>