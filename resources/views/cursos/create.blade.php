            ...
            <div id="panel-left" class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 m4">
                            <input id="duracion" type="text" class="validate" name="duracion" value="{{old('duracion')}}" required>
                        ...
                        <div class="input-field col s12 m4">
                            <input id="requisito" type="text" class="validate" name="requisito" value="{{old('requisito')}}" required>
                        ...
                        <div class="input-field col s12 m4">
                            <input id="nivel" type="text" class="validate" name="nivel" value="{{old('nivel')}}" required>
